...
Reproduces Table 2 / Figure 1 (left). For each of three random splits it trains
...
def run():
    X, Xds, y = D.load_flux()
    out = {k: [] for k in ["lgb_raw", "lgb_iso", "ngboost", "bnn_raw", "bnn_iso"]}
